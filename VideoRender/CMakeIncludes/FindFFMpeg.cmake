  ...
  if(FFMPEG_FOUND)
    ...
    if(NOT TARGET ffmpeg)
      ...
      set_target_properties(ffmpeg PROPERTIES
								   ...
								   INTERFACE_COMPILE_DEFINITIONS FFMPEG_VER_SHA=${FFMPEG_VERSION})

	#target_compile_definitions(ffmpeg INTERFACE_COMPILE_DEFINITIONS FFMPEG_VER_SHA=${FFMPEG_VERSION})
    endif()
  endif()
endif()
