...
from WeightSerializer import WeightSerializerBinary,WeightSerializerHDF5
import numpy as np
import pickle
...
class Model():
    def __init__(self, weight_file_path):
      """Overlay bounding boxes of face on images.
        ...
        Returns:
          None.
      """
      #self.weight_serializer = WeightSerializerBinary('./weights.binary','./weights_details.json')
      self.weight_serializer = WeightSerializerHDF5('./weights.h5')
    ...
    def _weight_variable_on_cpu(self, name, shape):
      ...
      prefix = name;
      self.weight_serializer.write_stream(prefix,'_filter',weights)
    ...
    def _bias_variable_on_cpu(self, name, shape):
      ...
      prefix = name;
      self.weight_serializer.write_stream(prefix,'_bias',bias)
    ...
    def _bn_variable_on_cpu(self, name, shape):
      ...
      prefix = name2;
      self.weight_serializer.write_stream(prefix,'_scale',scale)
      self.weight_serializer.write_stream(prefix,'_offset',offset)
      self.weight_serializer.write_stream(prefix,'_mean',mean)
      self.weight_serializer.write_stream(prefix,'_variance',variance)
    ...
    def dump_channel_averages(self,channel_averages):
        self.weight_serializer.write_stream("averages","",channel_averages)
        return

    def dump_clusters(self,clusters):
        self.weight_serializer.write_stream("clusters","",clusters)
        return

    def close_serializer(self):
        self.weight_serializer.close()
